...
//This is the client2 class to send/receive data from the server
public class ClientMain2 {
	...
	public static String sendpath = "F2.txt";
	public static String receivepath = "F3.txt";

	public static void main(String[] args) throws IOException {
		while (true) {
			try {
				//The client is connected to the dc01 machine where the server is running using the port 8061 on the utdallas server.
				...
				//Below is used receive data that is present on the file from the server.
	...
	//function is used to send the data byte chunks to the server
